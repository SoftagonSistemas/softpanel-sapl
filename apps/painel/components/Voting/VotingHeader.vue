    ...
    <v-card id="voting-header">
      <v-row class="bg-white">
        <v-col cols="12" sm="12" md="6" lg="3">
          <v-row>
            ...
            <v-col class="pa-3" cols="12">
              <h6 class="text-center text-bold font-weight-bold text-subtitle-1">
        ...
        <v-col cols="12" sm="12" md="6" lg="3" class="pa-8">
          <p class="py-2 bg-light-blue-darken-2 text-center">
            <strong>EM DISCUSSÃO</strong>
          </p>
        ...
        <v-col cols="12" sm="12" md="6" lg="3" class="my-2 px-4">
          <v-row class="bg-grey-darken-1">
            <v-col v-for="(item, index) in sss" :key="index" cols="12" md="6">
              <div class="d-flex text-center">
                <div :class="item.bgColor" class="vote-card-bg-width" />
                <p class="bg-grey-darken-3 w-100 text-h4">
