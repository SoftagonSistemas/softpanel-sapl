    ...
    <v-row id="proposition" class="my-5">
        <v-col cols="12" sm="12" md="5">
            <div class="d-flex flex-column">
                <div>
                    <span
                        class="d-inline-block text-grey-darken-4 px-5 bg-grey-lighten-3 text-h6 font-weight-bold"
                    >
                        Requerido por:
                    </span>
                </div>
                ...
                <div v-else>
                    <div
                        v-for="(author, index) in props.proposition
                            .parliamentaryName"
                        :key="author.id"
                    >
                        <div v-if="index < 3">
                            ...
                            <div v-show="author.party">
                                <span
                                    class="d-inline-block bg-grey-darken-1 px-10 py-1 text-center text-h5 font-weight-bold"
                                >
                                    {{ author.party }}
                                </span>
                            </div>
                    ...
                    <div
                        v-if="props.proposition.parliamentaryName.length > 3"
                        class="d-flex justify-end"
                    >
                        <div
                            class="text-grey-darken-4 bg-grey-lighten-3 d-inline pa-2 rounded text-h6 font-weight-bold"
                        >
                            E mais
                            {{
                                props.proposition.parliamentaryName.length -
                                    3 ===
                                1
                                    ? `um autor`
                                    : `${
                                          props.proposition.parliamentaryName
                                              .length - 3
                                      } autores`
                            }}
                        </div>
            ...
            >
                <div
                    class="bg-yellow-darken-2 pa-4 mt-12 mb-1 text-center font-weight-bold text-h5"
                >
                ...
                <div class="bg-yellow-darken-2 pa-4">
                    ...
                    <p>
                        Sessão <strong>{{ props.proposition.section }}</strong>
                    </p>
                </div>
            </v-col>
        </v-col>
        <v-col cols="12" sm="12" md="7">
            <div class="pa-4">
                ...
                <p
                    class="d-inline-block bg-grey-darken-1 px-10 py-1 text-center text-h6 font-weight-bold"
                >
